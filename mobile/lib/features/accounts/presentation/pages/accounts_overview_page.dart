...
class AccountsOverviewPage extends StatelessWidget {
  const AccountsOverviewPage({this.initialFilter = AccountsOverviewFilter.all, super.key});

  static const String path = '/cuentas-corrientes';
  static const String name = 'cuentas-corrientes';
  final AccountsOverviewFilter initialFilter;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: _AccountsOverviewView(role: role, initialFilter: initialFilter),
    );
  }
}

class _AccountsOverviewView extends StatefulWidget {
  const _AccountsOverviewView({required this.role, required this.initialFilter});
  final String role;
  final AccountsOverviewFilter initialFilter;
...
class _AccountsOverviewViewState extends State<_AccountsOverviewView> {
  ...
  void initState() {
    super.initState();
    if (widget.initialFilter != AccountsOverviewFilter.all) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        context.read<AccountsOverviewCubit>().setFilter(widget.initialFilter);
      });
    }
  }
