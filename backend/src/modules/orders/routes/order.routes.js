...
import {
  ...
  recalculateOrderPromotionsController,
...
orderRouter.post('/:id/recalculate-promotions', authorize(USER_ROLES.ADMIN, USER_ROLES.VENDEDOR), asyncHandler(recalculateOrderPromotionsController));
