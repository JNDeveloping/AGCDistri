...
export const upsertCompanySettingsSchema = z.object({
  ...
  primaryColor: z.string().regex(hexColorRegex, 'Color HEX inválido.'),
  secondaryColor: z.string().regex(hexColorRegex, 'Color HEX inválido.'),
  buttonColor: z.string().regex(hexColorRegex, 'Color HEX inválido.'),
  backgroundColor: z.string().regex(hexColorRegex, 'Color HEX inválido.'),
