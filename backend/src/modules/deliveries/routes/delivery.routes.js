...
deliveryRouter.post('/deliveries', authorize(USER_ROLES.ADMIN), validate(createDeliverySchema), asyncHandler(createDeliveryController));
...
deliveryRouter.post('/deliveries/:id/orders', authorize(USER_ROLES.ADMIN), validate(addOrdersToDeliverySchema), asyncHandler(addOrdersToDeliveryController));
